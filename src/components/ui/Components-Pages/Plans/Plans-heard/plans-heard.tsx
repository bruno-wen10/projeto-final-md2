...
<ClickableDiv clicked={click === 'medico'} onClick={() => handleClick('medico')}>

<span>Médicos</span>

<NumberTotal clicked={click === 'medico'}>{userData.totalDoctors}</NumberTotal>
</ClickableDiv>

<ClickableDiv clicked={click === 'contratante'} onClick={() => handleClick('contratante')}>
  <span>Contratantes</span>

  <NumberTotal clicked={click === 'contratante'}>{userData.totalContractor}</NumberTotal>
</ClickableDiv>
