import { DetailedHTMLProps, InputHTMLAttributes, ReactElement, ReactNode, RefObject } from "react"
import { SButton } from "./butonStyled"

type Props = React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> & {
  children: ReactNode
}
interface PropsRef extends DetailedHTMLProps<InputHTMLAttributes<HTMLInputElement>, HTMLInputElement> {
  label: string
  id: string
  hasError?: boolean
  icon?: ReactElement
